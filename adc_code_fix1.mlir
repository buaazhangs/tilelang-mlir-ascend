module attributes {hivm.module_core_type = #hivm.module_core_type<AIV>, memref.memref_as_ptr} {
  func.func @adc_func(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg1: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg2: memref<?xf32>, %arg3: memref<?xi8>, %arg4: memref<?xf32>, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "local", mix_mode = "aiv", parallel_mode = "simd"} {
    ...
    scf.for %arg12 = %c0_i32 to %11 step %c1_i32_2  : i32 {
      %12 = tensor.empty() : tensor<32x8xi8>
      %13 = tensor.empty() : tensor<1x32xf32>
      %14 = tensor.empty() : tensor<1x32xf32>
      ...
      %20:3 = scf.if %19 -> (tensor<32x8xi8>, tensor<1x32xf32>, tensor<1x32xf32>) {
        %c0_i32_3 = arith.constant 0 : i32
        %21 = arith.trunci %c0_i32_3 : i32 to i8
        %22 = linalg.fill ins(%21 : i8) outs(%12 : tensor<32x8xi8>) -> tensor<32x8xi8>
        %23 = arith.sitofp %c0_i32_3 : i32 to f32
        %24 = linalg.fill ins(%23 : f32) outs(%13 : tensor<1x32xf32>) -> tensor<1x32xf32>
        %c8_i32 = arith.constant 8 : i32
        %c1_i32_4 = arith.constant 1 : i32
        %25:2 = scf.for %arg13 = %c0_i32_3 to %c8_i32 step %c1_i32_4 iter_args(%arg14 = %22, %arg15 = %24) -> (tensor<32x8xi8>, tensor<1x32xf32>)  : i32 {
          %35 = tensor.empty() : tensor<8x32xi8>
          %36 = tensor.empty() : tensor<8x32xi32>
          %c1792_i32_7 = arith.constant 1792 : i32
          %37 = arith.muli %arg12, %c1792_i32_7 : i32
          %c32_i32_8 = arith.constant 32 : i32
          %38 = arith.muli %7, %c32_i32_8 : i32
          %39 = arith.addi %37, %38 : i32
          %40 = arith.index_cast %39 : i32 to index
          %41 = arith.subi %arg5, %38 : i32
          %42 = arith.subi %41, %37 : i32
          %43 = arith.minsi %c32_i32_8, %42 : i32
          ...
          %alloc_11 = memref.alloc() : memref<32x8xi8>
          %subview_12 = memref.subview %alloc_11[0, 0] [%44, 8] [1, 1] : memref<32x8xi8> to memref<?x8xi8, strided<[8, 1]>>
          ...
          %inserted_slice_14 = tensor.insert_slice %expanded_13 into %arg14[0, 0] [%44, 8] [1, 1] : tensor<?x8xi8> into tensor<32x8xi8>
          %transposed = linalg.transpose ins(%inserted_slice_14 : tensor<32x8xi8>) outs(%35 : tensor<8x32xi8>) permutation = [1, 0] 
          %48 = tensor.empty() : tensor<8x32xi8>
          %49 = hfusion.cast {cast = #hfusion.type_fn<cast_unsigned>, enable_overflow = true, round_mode = #hfusion.round_mode<rint>, unsigned_mode = #hfusion.unsigned_mode<ui2si>} ins(%transposed : tensor<8x32xi8>) outs(%36 : tensor<8x32xi32>) -> tensor<8x32xi32>
          %c0_i32_15 = arith.constant 0 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %50 = scf.for %arg16 = %c0_i32_15 to %c8_i32_9 step %c1_i32_16 iter_args(%arg17 = %arg15) -> (tensor<1x32xf32>)  : i32 {
            ...
            %extracted_slice_19 = tensor.extract_slice %49[%55, 0] [1, 32] [1, 1] : tensor<8x32xi32> to tensor<1x32xi32>
            %56 = hfusion.gather {operandSegmentSizes = array<i32: 2, 1>} ins(%extracted_slice_18, %extracted_slice_19 : tensor<1x256xf32>, tensor<1x32xi32>) outs(%51 : tensor<1x32xf32>) axis = 1 -> tensor<1x32xf32>
            %57 = linalg.elemwise_binary {fun = #linalg.binary_fn<add>} ins(%arg17, %56 : tensor<1x32xf32>, tensor<1x32xf32>) outs(%arg17 : tensor<1x32xf32>) -> tensor<1x32xf32>
            scf.yield %57 : tensor<1x32xf32>
          }
          scf.yield %inserted_slice_14, %50 : tensor<32x8xi8>, tensor<1x32xf32>
        }
        %26 = linalg.elemwise_unary {fun = #linalg.unary_fn<sqrt>} ins(%25#1 : tensor<1x32xf32>) outs(%14 : tensor<1x32xf32>) -> tensor<1x32xf32>
        ...
        %extracted_slice = tensor.extract_slice %26[0, 0] [1, %32] [1, 1] : tensor<1x32xf32> to tensor<?xf32>
        ...
        scf.yield %25#0, %25#1, %26 : tensor<32x8xi8>, tensor<1x32xf32>, tensor<1x32xf32>
      } else {
        scf.yield %12, %13, %14 : tensor<32x8xi8>, tensor<1x32xf32>, tensor<1x32xf32>
      }
    }
    return
  }
