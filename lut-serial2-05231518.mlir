...
module attributes {hivm.module_core_type = #hivm.module_core_type<AIV>, memref.memref_as_ptr} {
  ...
  func.func @main(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg1: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg2: memref<?xf32>, %arg3: memref<?xi32>, %arg4: memref<?xf32>, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "local", mix_mode = "aiv", parallel_mode = "mix_simd_simt"} {
    ...
    %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [0], sizes: [2, 256], strides: [%2, %0] : memref<?xf32> to memref<2x256xf32, strided<[256, 1]>>
    %c128_i32 = arith.constant 128 : i32
    %3 = arith.muli %c128_i32, %c1_i32 : i32
    %4 = arith.index_cast %3 : i32 to index
    %reinterpret_cast_0 = memref.reinterpret_cast %arg4 to offset: [0], sizes: [2, 128], strides: [%4, %0] : memref<?xf32> to memref<2x128xf32, strided<[128, 1]>>
    %reinterpret_cast_1 = memref.reinterpret_cast %arg3 to offset: [0], sizes: [2, 256], strides: [%2, %0] : memref<?xi32> to memref<2x256xi32, strided<[256, 1]>>
    %5 = hivm.hir.get_block_idx -> i64
    %6 = arith.trunci %5 : i64 to i32
    %7 = hivm.hir.get_sub_block_idx -> i64
    %8 = arith.trunci %7 : i64 to i32
    %9 = tensor.empty() : tensor<2x256xi32>
    %alloc = memref.alloc() : memref<2x256xi32>
    memref.copy %reinterpret_cast_1, %alloc : memref<2x256xi32, strided<[256, 1]>> to memref<2x256xi32>
    %10 = bufferization.to_tensor %alloc restrict : memref<2x256xi32>
    %inserted_slice = tensor.insert_slice %10 into %9[0, 0] [2, 256] [1, 1] : tensor<2x256xi32> into tensor<2x256xi32>
    %c0_i32 = arith.constant 0 : i32
    %c2_i32 = arith.constant 2 : i32
    %c1_i32_2 = arith.constant 1 : i32
    scf.for %arg11 = %c0_i32 to %c2_i32 step %c1_i32_2  : i32 {
      %11 = tensor.empty() : tensor<256xf32>
      %12 = arith.index_cast %arg11 : i32 to index
      %extracted_slice = tensor.extract_slice %inserted_slice[%12, 0] [1, 256] [1, 1] : tensor<2x256xi32> to tensor<1x256xi32>
      ...
      %subview = memref.subview %reinterpret_cast_0[%12, 0] [1, 128] [1, 1] : memref<2x128xf32, strided<[128, 1]>> to memref<128xf32, strided<[1], offset: ?>>
