2026-05-22 06:15:11  [TileLang:tilelang.env:WARNING]: CUTLASS is not installed or found in the expected path
...
CODES_UB = T.Buffer((4, 256), "int32", scope="shared")
O_UB = T.Buffer((256,), scope="shared")
T.npuir_indirect_load(T.region(LUT[s, 0], 1, 1, 256), T.region(CODES_UB[s, 0], 1, 1, 256), T.region(O_UB[0], 2, 256), 128)
====== TVM IR ======
...
module attributes {hivm.module_core_type = #hivm.module_core_type<AIV>, memref.memref_as_ptr} {
  func.func private @triton_indirect_load(memref<4x256xf32, strided<[256, 1]>>, tensor<256xi64>, tensor<256xi1>, tensor<256xf32>) -> tensor<256xf32>
  func.func @main(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg1: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg2: memref<?xf32>, %arg3: memref<?xi32>, %arg4: memref<?xf32>, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "local", mix_mode = "aiv", parallel_mode = "mix_simd_simt"} {
    ...
    scf.for %arg11 = %c0_i32 to %c4_i32 step %c1_i32_2  : i32 {
      ...
      %26 = func.call @triton_indirect_load(%reinterpret_cast, %18, %23, %25) : (memref<4x256xf32, strided<[256, 1]>>, tensor<256xi64>, tensor<256xi1>, tensor<256xf32>) -> tensor<256xf32>
...
cmd_list ['/data/pri/Ascend/9.1.0.B010/cann-9.1.0/bin/bishengir-compile', '/tmp/tmp2cudkl_c/kernel.npuir', '--target=Ascend950PR_9579', '--enable-auto-multi-buffer=true', '--disable-ffts', '--enable-triton-kernel-compile=true', '--enable-hivm-compile=true', '--enable-vf-merge-level=1', '--enable-hfusion-compile=true', '--enable-auto-bind-sub-block=true', '-o', '/tmp/tmp2cudkl_c/kernel']
...
[E522 06:15:17.587917807 OpParamMaker.cpp:454] operator():../third_party/op-plugin/op_plugin/ops/opapi/ArangeKernelNpuOpApi.cpp:36 NPU function error: device error type 3, error code is 507035
[ERROR] 2026-05-22-06:15:17 (PID:3230, Device:0, RankID:-1) ERR00100 PTA call acl api failed
[Error]: The vector core execution is abnormal. 
        Rectify the fault based on the error information in the ascend log.
[PID: 3230] 2026-05-22-06:15:17.944.827 AclNN_Runtime_Error(EZ9903): aclrtLaunchKernelWithHostArgs failed, return: 507035
        Solution: In this scenario, collect the plog when the fault occurs and locate the fault based on the plog.
        TraceBack (most recent call last):
        The error from device(chipId:0, dieId:0), serial number is 19, there is an aivec error exception, core id is 0, error code = 341, dump info: pc start: 0x120041006000, current: 0x120041006258, sc error info: 0xffffffffffff, su error info: 0xb8dcdfe313b00042,0x42400c4cd0005566, mte error info: 0x7294e57a0004cfff, vec error info: 0x410063580039187d, cube error info: 0, l1 error info: 0, aic error mask: 0x395856, para base: 0x12004c600378, mte error: 0.[FUNC:ProcessDavidStarsCoreErrorInfo][FILE:device_error_proc_c.cc][LINE:592]
        ...
        stream_id=53, retCode=0x715005e.[FUNC:StreamLaunchKernelV2][FILE:aix_c.cc][LINE:488]
...
frame #0: c10::Error::Error(c10::SourceLocation, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >) + 0x98 (0x7f479893a218 in /usr/local/python3.11.13/lib/python3.11/site-packages/torch/lib/libc10.so)
frame #1: c10::detail::torchCheckFail(char const*, char const*, unsigned int, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const&) + 0xe0 (0x7f47988cef72 in /usr/local/python3.11.13/lib/python3.11/site-packages/torch/lib/libc10.so)
frame #2: <unknown function> + 0x168fae1 (0x7f46c068cae1 in /usr/local/python3.11.13/lib/python3.11/site-packages/torch_npu/lib/libtorch_npu.so)
frame #3: <unknown function> + 0x40c46e7 (0x7f46c30c16e7 in /usr/local/python3.11.13/lib/python3.11/site-packages/torch_npu/lib/libtorch_npu.so)
frame #4: <unknown function> + 0x113ca41 (0x7f46c0139a41 in /usr/local/python3.11.13/lib/python3.11/site-packages/torch_npu/lib/libtorch_npu.so)
frame #5: <unknown function> + 0x113fa68 (0x7f46c013ca68 in /usr/local/python3.11.13/lib/python3.11/site-packages/torch_npu/lib/libtorch_npu.so)
frame #6: <unknown function> + 0x113b747 (0x7f46c0138747 in /usr/local/python3.11.13/lib/python3.11/site-packages/torch_npu/lib/libtorch_npu.so)
frame #7: <unknown function> + 0xdc253 (0x7f47838cc253 in /lib/x86_64-linux-gnu/libstdc++.so.6)
frame #8: <unknown function> + 0x94ac3 (0x7f47994cfac3 in /lib/x86_64-linux-gnu/libc.so.6)
frame #9: <unknown function> + 0x126850 (0x7f4799561850 in /lib/x86_64-linux-gnu/libc.so.6)
...
Traceback (most recent call last):
  File "/data/z00910011/tilelang-mlir-ascend/examples/simt/indirect_load_lut2d.py", line 75, in <module>
    main(args.n, args.block, args.num_subspaces, args.codebook_size)
  File "/data/z00910011/tilelang-mlir-ascend/examples/simt/indirect_load_lut2d.py", line 64, in main
...
[Error]: The vector core execution is abnormal. 
        Rectify the fault based on the error information in the ascend log.
EE9999: Inner Error!
EE9999[PID: 3230] 2026-05-22-06:15:17.960.362 (EE9999):  rtStreamSynchronizeWithTimeout execution failed, reason=vector core exception[FUNC:FuncErrorReason][FILE:error_message_manage.cc][LINE:65]
        TraceBack (most recent call last):
